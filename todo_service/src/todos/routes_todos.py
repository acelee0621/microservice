...
from src.todos.repository_todos import TodosRepository
from src.todos.service_todos import TodosService
from src.todos.schemas import TodoUpdate, TodoResponse, UserRead
...
async def get_all_todos(
    ...
    order_by: Annotated[
        str | None,
        Query(
            description="Order by field (e.g., created_at desc/asc, priority desc/asc)"
        ),
    ] = None,
    service: TodosService = Depends(get_todos_service),
    current_user: UserRead = Depends(get_current_user),
